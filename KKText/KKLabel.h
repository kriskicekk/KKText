...
/**
 The KKLabel class implements a read-only text view.
 ...
 */
@interface KKLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is KKTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) KKTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) KKTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) KKTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) KKTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) KKTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `KKTextLayout` class in background thread. Here's an example:
    
    KKLabel *label = [KKLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        text.kk_color = [UIColor grayColor];
        [text kk_setColor:[UIColor redColor] range:NSMakeRange(0, 4)];
 
        // Create text container
        KKTextContainer *container = [KKTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        KKTextLayout *layout = [KKTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<KKTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) KKTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) KKTextAction textTapAction;
@property (nullable, nonatomic, copy) KKTextAction textLongPressAction;
@property (nullable, nonatomic, copy) KKTextAction highlightTapAction;
@property (nullable, nonatomic, copy) KKTextAction highlightLongPressAction;
