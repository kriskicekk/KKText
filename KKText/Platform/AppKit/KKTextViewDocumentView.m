...
- (BOOL)isFlipped {
    // Use a top-left origin to simplify conversion with KKTextLayout coordinates.
    return YES;
}

- (BOOL)acceptsFirstResponder {
    // KKTextView owns first responder status; documentView only hosts content.
    return NO;
}
