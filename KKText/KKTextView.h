...
/**
 The KKTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for KKTextView objects. 
...
- (void)textViewDidBeginEditing:(KKTextView *)textView;
- (void)textViewDidEndEditing:(KKTextView *)textView;
- (BOOL)textView:(KKTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(KKTextView *)textView;
- (void)textViewDidChangeSelection:(KKTextView *)textView;

- (BOOL)textView:(KKTextView *)textView shouldTapHighlight:(KKTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(KKTextView *)textView didTapHighlight:(KKTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(KKTextView *)textView shouldLongPressHighlight:(KKTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(KKTextView *)textView didLongPressHighlight:(KKTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
@property (nullable, nonatomic, weak) id<KKTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is KKTextVerticalAlignmentTop.
 */
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and KKTextAttribute.
 See `NSAttributedString+KKText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `KKTextParser` protocol for more information.
 */
...
/**
 ...
 See `KKTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<KKTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [KKTextDebugOption sharedDebugOption].
 */
...
@property (nonatomic) IBInspectable KKTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const KKTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const KKTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const KKTextViewTextDidEndEditingNotification;
