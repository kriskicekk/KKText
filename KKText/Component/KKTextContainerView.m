...
@implementation KKTextContainerView {
...
- (void)setLayout:(KKTextLayout *)layout {
...
- (void)setLayout:(KKTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_attachmentChanged) {
        ...
        for (KKTextAttachment *a in _layout.attachments) {
