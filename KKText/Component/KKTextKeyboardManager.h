...
/**
 ...
 Use -[KKTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} KKTextKeyboardTransition;


/**
 The KKTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol KKTextKeyboardObserver <NSObject>
@optional
...
/**
 A KKTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface KKTextKeyboardManager : NSObject
