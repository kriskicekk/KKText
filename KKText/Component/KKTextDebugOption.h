...
@class KKTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The KKTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol KKTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable KKTextDebugOption *)option;
@end



/**
 The debug option for KKText.
 */
@interface KKTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable KKTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable KKTextDebugOption *)option;
