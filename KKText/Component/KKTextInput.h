 ...
 */
typedef NS_ENUM(NSInteger, KKTextAffinity) {
    KKTextAffinityForward  = 0, ///< offset appears before the character
    KKTextAffinityBackward = 1, ///< offset appears after the character
};


/**
 A KKTextPosition object represents a position in a text container; in other words, 
 it is an index into the backing string in a text-displaying view.
 
 KKTextPosition has the same API as Apple's implementation in UITextView/UITextField,
 so you can alse use it to interact with UITextView/UITextField.
 */
@interface KKTextPosition : UITextPosition <NSCopying>

@property (nonatomic, readonly) NSInteger offset;
@property (nonatomic, readonly) KKTextAffinity affinity;
...
/**
 A KKTextRange object represents a range of characters in a text container; in other words, 
 it identifies a starting index and an ending index in string backing a text-displaying view.
 
 KKTextRange has the same API as Apple's implementation in UITextView/UITextField,
 so you can alse use it to interact with UITextView/UITextField.
 */
@interface KKTextRange : UITextRange <NSCopying>

@property (nonatomic, readonly) KKTextPosition *start;
@property (nonatomic, readonly) KKTextPosition *end;
...
/**
 A KKTextSelectionRect object encapsulates information about a selected range of 
 text in a text-displaying view.
 
 KKTextSelectionRect has the same API as Apple's implementation in UITextView/UITextField,
 so you can alse use it to interact with UITextView/UITextField.
 */
@interface KKTextSelectionRect : UITextSelectionRect <NSCopying>
