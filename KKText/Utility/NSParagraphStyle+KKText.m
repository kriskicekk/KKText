...
@interface NSParagraphStyle_KKText : NSObject @end
@implementation NSParagraphStyle_KKText @end


@implementation NSParagraphStyle (KKText)

+ (NSParagraphStyle *)kk_styleWithCTStyle:(CTParagraphStyleRef)CTStyle {
...
- (CTParagraphStyleRef)kk_CTStyle CF_RETURNS_RETAINED {
