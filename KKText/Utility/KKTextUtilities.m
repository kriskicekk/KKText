...
CGAffineTransform KKTextCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform KKTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from kk_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from kk_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from kk_convertPoint:before[2] toViewOrWindow:to];
    
    return KKTextCGAffineTransformGetFromPoints(before, after);
}
