...
/**
 The KKTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface KKTextAsyncLayer : CALayer
...
/**
 The KKTextAsyncLayer's delegate protocol. The delegate of the KKTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol KKTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by KKTextAsyncLayer to render the contents in background queue.
 */
@interface KKTextAsyncLayerDisplayTask : NSObject
