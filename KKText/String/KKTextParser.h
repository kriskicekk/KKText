...
/**
 The KKTextParser protocol declares the required method for KKTextView and KKLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 KKTextView and KKLabel. See `KKTextSimpleMarkdownParser` and `KKTextSimpleEmoticonParser` for example.
 */
@protocol KKTextParser <NSObject>
@required
/**
 When text is changed in KKTextView or KKLabel, this method will be called.
 ...
 no selected range (such as KKLabel), this value is NULL.
 ...
 */
@interface KKTextSimpleMarkdownParser : NSObject <KKTextParser>
 ...
 */
@interface KKTextSimpleEmoticonParser : NSObject <KKTextParser>
