 ...
 */
@interface KKTextRunDelegate : NSObject <NSCopying, NSCoding>

/**
 Creates and returns the CTRunDelegate.
 
 @discussion You need call CFRelease() after used.
 The CTRunDelegateRef has a strong reference to this KKTextRunDelegate object.
 In CoreText, use CTRunDelegateGetRefCon() to get this KKTextRunDelegate object.
